...
ob_start();
      ...
      <a class="navbar-brand" href="#">Filter Items</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <form id="itemFilter" class="form-inline my-2 my-lg-0" method="GET" action="index.php">
            ...
            <label for="status">Status:</label>
              ...
              <a href="index.php?action=filter&show=all&status=all&price=all&rating=all&search=<?php echo $search?>" class="clearFilter btn btn-outline-primary my-2 my-sm-0" >Clear Filter</a>
          </ul>
    ...
    <?php  if (isset($_GET['search']) && $_GET['search'] !== "all") { ?>
        ...
        <div class="card col-md-4 <?php echo ($bought) ? "sold":"offered" ?> " >
          ...
          <div class="card-body">
            ...
            <div class="userCatActions">
              <div><span>Declared By : </span><a class="mya" href='profile.php?userid=<?php echo $row['userid']?>'> <?php echo $row['username'] ?></a></div>
                ...
                <div class="popup-child" data-popup="<?php echo $row['itemid'];?>" data-class="comments">
                  ...
                  <div>
                    ...
                    <div  id="forScrollComments"
                      ...
                      <div class="border p-3 bg-light media mediacom mediacomnormallik">
                        ...
                        <div class="media-body">
                          ...
                          <div style="display: flex; justify-content:space-between;">
                            <p id = "<?php echo $comment['comid']?>" class="thisComment text-muted"><?php echo $comment['comment'];?></p>
                            <?php if (isset($_SESSION['uid']) && $_SESSION['uid'] == $comment['userid']) {?>
                            <div class="options">
                              <button id = "<?php echo $comment['comid']?>" class="editComment btn mysuccess"> <i class='fa fa-lg fa-edit'></i></button>
                              <button id = "<?php echo $comment['comid']?>" class="deleteComment btn mydanger"> <i class='fa fa-lg fa-trash'></i></button>
                    ...
                    <div style="display: flex; justify-content:space-between; width:100%">
                      <input id="commentitemid" type="hidden" value= "<?php echo $row['itemid'];?>" />
    ...
    <?php }	else {
      ...
      <?php } else if ((isset($_GET['search'])) && ($_GET['search'] === "all")) { 
                ...
                redirect($msg, "index.php", 'Clear filter');?>
                <a href="index.php" class="save btn btn-primary text-white"><i class="fa fa-reply fa-lg"></i> Clear Filter Now</a>
      ...
      ?>
      <a href="items.php?do=add" class="save btn btn-primary"><i class="fa fa-plus"></i> New Item</a>
    </div>
  	<?php
