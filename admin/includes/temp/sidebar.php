...
?>
			...
			<div class="left">
                ...
                <div class="account-info" >
                    <a href="members.php?do=profile&userid=<?php echo $userid?>" class='btn  table-control' style="padding:5px; width: 100px; height:100px; border-radius: 50%; border: 1px solid #333"  > 
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                    ...
                                    <li><a  href="items.php?action=filter&show=2&status=all&price=all&rating=all&search=all">Pending Items</a></li>
